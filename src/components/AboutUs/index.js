      ...
      <div className="background-image-main">
        ...
        <div className="about-section-image2">
          <animated.div style={poppingOutAnimation(400)}>
            <Image className="main-section-inner" src={AboutImage2} width={93} height={93} />
          </animated.div>
        </div>
        ...
        <div className="about-section-image4">
          <animated.div style={poppingOutAnimation(1000)}>
            <Image className="main-section-inner" src={AboutImage4} width={81} height={81} />
          </animated.div>
        </div>
        <div className="about-section-image5">
          <animated.div style={poppingOutAnimation(2000)}>
            ...
            <Image className="main-section-inner" src={AboutImage5} width={93} height={93} />
          </animated.div>
        </div>
        ...
        <div className="about-section-image7">
          <animated.div style={poppingOutAnimation(0)}>
            <Image className="main-section-inner" src={AboutImage7} width={93} height={93} />
          </animated.div>
        </div>
...
{/* <div className="waveformm" style={{ width: '80%', marginLeft: '5%'}}>
...
<Waveform />
      ...
      <InteractionCard 
        ...
        leftAbsolute={'23%'}
        count={'02'}
        heading={'Human interaction is at the core of PAAQ - the more people connect'}
        detail={'The more vast knowledge is accessed through the app & community, with users getting information directly from the relevant source or individuals they deem credible - Bridging the knowledge market'}
        />
        <InteractionCard 
        ...
        detail={'Who can help them make better life choices & advance their skills within their designated professions - enabling them to make money for collaborating and contributing positively to global economic development.'}
        />
        <InteractionCard 
        alignImageRight={true}
        image={IntImage3}
        ...
        detail={'Where everyone can gain knowledge and build relationships without feeling isolated or ignored.'}
        />
    </>
  );
}
