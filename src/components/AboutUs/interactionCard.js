...
console.log("props", props)
    const { alignImageRight, heading, detail,mobileclass, image, imageHeight, imageWidth, leftAbsolute, count, topAbsolute} = props;
  // console.log("alignImageRight==>", alignImageRight)
    ...
    <div className="interaction-card-main" style={{ flexDirection: width < 760 ? 'column' : alignImageRight ? 'row' : 'row-reverse', background: count ? '#ffffff' : width > 760 ? '#F6F6F6' : '#ffffff' }}>
        ...
        <div className={`${mobileclass} interaction-card-right`} style={{ justifyContent: alignImageRight, objectFit:'contain' }}>
