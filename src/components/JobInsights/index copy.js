...
const JobInsightsMain = () => {
     ...
     const TEST_PEAKS = [
          ...
          0.9399999999999999, 0.91, 0.82, 0.96, 0.91, 0.93, 0.93, 0.98, 0.99, 0.98, 0.99,
          0.98, 0.98, 0.98, 0.98, 0.98, 0.98, 0.98, 0.85, 0.82,
     ];
               ...
               <div className="background-image-main">
                    ...
                    <div className="aboutus-left-section">
                         ...
                         <p className="aboutus-left-section-detail">
                              The widespread use of social media and professional
                              platforms has made people more willing to accept
                              intentionally structured knowledge from those they deem to
                              be experts. Information sought can be either social,
                              professional, or any other specialized information deemed
                              valuable by the person seeking it.
                         </p>
                    </div>
