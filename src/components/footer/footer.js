...
export default function Footer() {
    ...
    <footer className='footer-mobile-view' sx={styles.footer}>
      <Container style={{ width: '100%' }}>
        ...
        <div className='footer-copyright-container'>
          ...
          <a href="https://www.linkedin.com/company/paaq-app">  <div className='icon-bg'>
            {/* <img src={Linkedin} /> */}
          ...
          <a href="https://twitter.com/paaq_app_">    <div className='icon-bg'>
            {/* <img src={Twitter} /> */}
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
          ...
          <a href="https://medium.com/@paaq">    <div className='icon-bg'>
            {/* <img src={Simple} /> */}
          ...
          <a href="https://www.tiktok.com/@paaq.app">    <div className='icon-bg'>
            {/* <img src={Tiktok} /> */}
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
