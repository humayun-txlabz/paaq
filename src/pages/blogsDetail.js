                         ...
                         <Container style={styles.main}>
                              <Container style={styles.textContainer1}>
                                   <Text style={styles.heading}>
                                        5 Simple Money Moves That Will Impact Your
                                        Finances in a Big Way
                                   </Text>
                              </Container>
                              <Container style={styles.nextContainer}>
                                   <Text style={styles.next}>SHARE</Text>
                                   {svgs.map((item) => {
                                        return (
                              ...
                              <Container style={styles.descriptionContainer}>
                                   ...
                                   <Text style={styles.description}>
                                        lthough many geographers are trained in toponymy
                                        and cartology, this is not their main
                                        preoccupation. Geographers study the space and the
                                        temporal database distribution of phenomena,
                                        processes, and features as. Well as the
                                        interaction of humans and their environment.
                                        Because space and place affect a variety of
                                        topics,
                                   </Text>
                              </Container>
                              <Container style={styles.remainingDescriptionContainer}>
                                   <Text style={styles.remainingDescription}>
                                        well as the interaction of humans and their
                                        environment. Because space and place affect a
                                        variety of topics, such as economics, health,
                                        climate, plants and animals, geography is highly
                                        interdisciplinary. The interdisciplinary nature of
                                        the geographical approach depends
                                        on an attentiveness to the relationship between
...
The difference between these approaches led to a third field, environmental geography, which combines physical and human geography and concerns the interactions between the environment and humans.`}
                                   ...
                                   <Text style={styles.description2}>
                                        ...
                                        geography as both art and science, achieved this
                                        through Cartography, Philosophy, and Literature,
                                        or through Mathematics. There is some debate about
                                        who was the first person to assert that the Earth
                                        is spherical in shape, with the credit going
                                        either to Parmenides or Pythagoras. Anaxagoras was
                                        able to demonstrate that the profile of the Earth
                                        was circular by explaining eclipses. However, he
                                        still believed that the Earth was a flat disk, as
